...
class FilterClass:
    ...
    def filter(self):
        ...
        filtered_df_10['domain'] = filtered_df_10['email'].apply(extract_domain)
        ...
        filtered_df["email_response"] = filtered_df.apply(lambda row: generate_email(row, self.jobDescription), axis=1)
        filtered_df.to_csv('outreach.csv')
        return filtered_df